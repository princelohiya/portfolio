...
export const portfolioData = {
  ...
  skills: {
    languages: ['JavaScript (ES6+)', 'TypeScript', 'C++', 'Python', 'Java', 'HTML5', 'CSS3'],
    frontend: ['React.js', 'Next.js', 'Tailwind CSS', 'Framer Motion', 'Recoil', 'Zod', 'EJS'],
    backend: ['Node.js', 'Express.js', 'NestJS', 'Hono (Serverless)', 'REST APIs', 'WebSockets', 'Stripe'],
    database: ['PostgreSQL', 'MongoDB', 'Prisma ORM', 'Redis', 'Cloudflare KV'],
    cloud: ['AWS (EC2, S3, CloudFront)', 'Docker', 'Nginx', 'TurboRepo', 'Vercel', 'Cloudflare Workers', 'Git'],
  ...
  projects: [
    {
      ...
      description: 'Context-aware Q&A over large PDF documents using a RAG pipeline.',
      highlights: [
    ...
    },
    {
      ...
      description: 'Client-side AES end-to-end encrypted messaging with zero-knowledge architecture.',
      highlights: [
    ...
    },
    {
      ...
      description: 'Digital wallet with atomic transactions for consistent concurrent fund transfers.',
      highlights: [
